    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav flex-nowrap ms-auto">
                                    ...
                                    <h6 class="dropdown-header">alerts center</h6><a class="dropdown-item d-flex align-items-center" href="#">
                                        ...
                                        <div class="fw-bold">
                                            <div class="text-truncate">
                                                <span>Last month's report looks great, I am very happy with the progress so far, keep up the good work!</span></div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span
                                        class="d-none d-lg-inline me-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile"
                                ...
                                <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="#"><i
                                            class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile</a><a class="dropdown-item" href="#"><i
                                            class="fas fa-cogs fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Settings</a><a class="dropdown-item" href="#"><i
            ...
            <div class="container-fluid">
                ...
                @if (\Illuminate\Support\Facades\Session::has('validator') && \Illuminate\Support\Facades\Session::has('validator'))
                    @foreach (\Illuminate\Support\Facades\Session::get('validator') as $key=> $value)
                        @foreach($value as $k => $message)
                            <div class="alert alert-danger" role="alert">
                                {!! $message !!}
                            </div>
                        @endforeach
